...
pub fn check_access(req: &HttpRequest, srv_data: &web::Data<Arc<RwLock<data::Body>>>) -> bool {
	is_origin_local(req) || check_master_token(req, srv_data)
}
...
pub fn check_master_token(req: &HttpRequest, srv_data: &web::Data<Arc<RwLock<data::Body>>>) -> bool {
